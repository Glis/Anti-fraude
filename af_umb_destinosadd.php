...
$( document ).ready(function() {
    $('#x_c_IDestino').empty();
    $('#x_c_IDestino').append($('.new_select').html());
});
...
<select class= "form-control" data-field="x_c_IDestino" id="x_c_IDestino" name="x_c_IDestino"<?php echo $af_umb_destinos->c_IDestino->EditAttributes() ?>>
<?php
