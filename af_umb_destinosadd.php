...
$af_umb_destinos_add = NULL; // Initialize page object first

class caf_umb_destinos_add extends caf_umb_destinos {
	...
	// Page object name
	var $PageObjName = 'af_umb_destinos_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "af_umb_destinosview.php")
	...
	function LoadDefaultValues() {
		...
		$this->q_MinAl_Plataf->CurrentValue = NULL;
		$this->q_MinAl_Plataf->OldValue = $this->q_MinAl_Plataf->CurrentValue;
		$this->q_MinCu_Plataf->CurrentValue = NULL;
		$this->q_MinCu_Plataf->OldValue = $this->q_MinCu_Plataf->CurrentValue;
		$this->q_MinAl_Res->CurrentValue = NULL;
		$this->q_MinAl_Res->OldValue = $this->q_MinAl_Res->CurrentValue;
		$this->q_MinCu_Res->CurrentValue = NULL;
		$this->q_MinCu_Res->OldValue = $this->q_MinCu_Res->CurrentValue;
		$this->q_MinAl_CClas->CurrentValue = NULL;
		$this->q_MinAl_CClas->OldValue = $this->q_MinAl_CClas->CurrentValue;
		$this->q_MinCu_CClas->CurrentValue = NULL;
		$this->q_MinCu_CClas->OldValue = $this->q_MinCu_CClas->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// q_MinAl_Plataf
		$this->q_MinAl_Plataf->SetDbValueDef($rsnew, $this->q_MinAl_Plataf->CurrentValue, 0, FALSE);

		// q_MinCu_Plataf
		$this->q_MinCu_Plataf->SetDbValueDef($rsnew, $this->q_MinCu_Plataf->CurrentValue, 0, FALSE);

		// q_MinAl_Res
		$this->q_MinAl_Res->SetDbValueDef($rsnew, $this->q_MinAl_Res->CurrentValue, 0, FALSE);

		// q_MinCu_Res
		$this->q_MinCu_Res->SetDbValueDef($rsnew, $this->q_MinCu_Res->CurrentValue, 0, FALSE);

		// q_MinAl_CClas
		$this->q_MinAl_CClas->SetDbValueDef($rsnew, $this->q_MinAl_CClas->CurrentValue, 0, FALSE);

		// q_MinCu_CClas
		$this->q_MinCu_CClas->SetDbValueDef($rsnew, $this->q_MinCu_CClas->CurrentValue, 0, FALSE);
...
// Create page object
if (!isset($af_umb_destinos_add)) $af_umb_destinos_add = new caf_umb_destinos_add();

// Page init
$af_umb_destinos_add->Page_Init();

// Page main
$af_umb_destinos_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_umb_destinos_add->Page_Render();
?>
...
// Page object
var af_umb_destinos_add = new ew_Page("af_umb_destinos_add");
af_umb_destinos_add.PageID = "add"; // Page ID
var EW_PAGE_ID = af_umb_destinos_add.PageID; // For backward compatibility

// Form object
var faf_umb_destinosadd = new ew_Form("faf_umb_destinosadd");

// Validate form
faf_umb_destinosadd.Validate = function() {
...
faf_umb_destinosadd.Form_CustomValidate = 
...
faf_umb_destinosadd.ValidateRequired = true;
<?php } else { ?>
faf_umb_destinosadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faf_umb_destinosadd.Lists["x_c_IDestino"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $af_umb_destinos_add->ShowPageHeader(); ?>
<?php
$af_umb_destinos_add->ShowMessage();
?>
...
<select data-field="x_c_IDestino" id="x_c_IDestino" name="x_c_IDestino"<?php echo $af_umb_destinos->c_IDestino->EditAttributes() ?>>
<?php
if (is_array($af_umb_destinos->c_IDestino->EditValue)) {
	$arwrk = $af_umb_destinos->c_IDestino->EditValue;
	$rowswrk = count($arwrk);
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($af_umb_destinos->c_IDestino->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
faf_umb_destinosadd.Lists["x_c_IDestino"].Options = <?php echo (is_array($af_umb_destinos->c_IDestino->EditValue)) ? ew_ArrayToJson($af_umb_destinos->c_IDestino->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<input type="text" data-field="x_q_MinAl_Plataf" name="x_q_MinAl_Plataf" id="x_q_MinAl_Plataf" size="30" placeholder="<?php echo ew_HtmlEncode($af_umb_destinos->q_MinAl_Plataf->PlaceHolder) ?>" value="<?php echo $af_umb_destinos->q_MinAl_Plataf->EditValue ?>"<?php echo $af_umb_destinos->q_MinAl_Plataf->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_q_MinCu_Plataf" name="x_q_MinCu_Plataf" id="x_q_MinCu_Plataf" size="30" placeholder="<?php echo ew_HtmlEncode($af_umb_destinos->q_MinCu_Plataf->PlaceHolder) ?>" value="<?php echo $af_umb_destinos->q_MinCu_Plataf->EditValue ?>"<?php echo $af_umb_destinos->q_MinCu_Plataf->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_q_MinAl_Res" name="x_q_MinAl_Res" id="x_q_MinAl_Res" size="30" placeholder="<?php echo ew_HtmlEncode($af_umb_destinos->q_MinAl_Res->PlaceHolder) ?>" value="<?php echo $af_umb_destinos->q_MinAl_Res->EditValue ?>"<?php echo $af_umb_destinos->q_MinAl_Res->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_q_MinCu_Res" name="x_q_MinCu_Res" id="x_q_MinCu_Res" size="30" placeholder="<?php echo ew_HtmlEncode($af_umb_destinos->q_MinCu_Res->PlaceHolder) ?>" value="<?php echo $af_umb_destinos->q_MinCu_Res->EditValue ?>"<?php echo $af_umb_destinos->q_MinCu_Res->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_q_MinAl_CClas" name="x_q_MinAl_CClas" id="x_q_MinAl_CClas" size="30" placeholder="<?php echo ew_HtmlEncode($af_umb_destinos->q_MinAl_CClas->PlaceHolder) ?>" value="<?php echo $af_umb_destinos->q_MinAl_CClas->EditValue ?>"<?php echo $af_umb_destinos->q_MinAl_CClas->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_q_MinCu_CClas" name="x_q_MinCu_CClas" id="x_q_MinCu_CClas" size="30" placeholder="<?php echo ew_HtmlEncode($af_umb_destinos->q_MinCu_CClas->PlaceHolder) ?>" value="<?php echo $af_umb_destinos->q_MinCu_CClas->EditValue ?>"<?php echo $af_umb_destinos->q_MinCu_CClas->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_q_MinAl_Cli" name="x_q_MinAl_Cli" id="x_q_MinAl_Cli" size="30" placeholder="<?php echo ew_HtmlEncode($af_umb_destinos->q_MinAl_Cli->PlaceHolder) ?>" value="<?php echo $af_umb_destinos->q_MinAl_Cli->EditValue ?>"<?php echo $af_umb_destinos->q_MinAl_Cli->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_q_MinCu_Cli" name="x_q_MinCu_Cli" id="x_q_MinCu_Cli" size="30" placeholder="<?php echo ew_HtmlEncode($af_umb_destinos->q_MinCu_Cli->PlaceHolder) ?>" value="<?php echo $af_umb_destinos->q_MinCu_Cli->EditValue ?>"<?php echo $af_umb_destinos->q_MinCu_Cli->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_q_MinAl_Cta" name="x_q_MinAl_Cta" id="x_q_MinAl_Cta" size="30" placeholder="<?php echo ew_HtmlEncode($af_umb_destinos->q_MinAl_Cta->PlaceHolder) ?>" value="<?php echo $af_umb_destinos->q_MinAl_Cta->EditValue ?>"<?php echo $af_umb_destinos->q_MinAl_Cta->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_q_MinCu_Cta" name="x_q_MinCu_Cta" id="x_q_MinCu_Cta" size="30" placeholder="<?php echo ew_HtmlEncode($af_umb_destinos->q_MinCu_Cta->PlaceHolder) ?>" value="<?php echo $af_umb_destinos->q_MinCu_Cta->EditValue ?>"<?php echo $af_umb_destinos->q_MinCu_Cta->EditAttributes() ?>>
</span>
...
<script type="text/javascript">
faf_umb_destinosadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$af_umb_destinos_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$af_umb_destinos_add->Page_Terminate();
?>
