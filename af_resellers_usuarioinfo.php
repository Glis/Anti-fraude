...
class caf_resellers_usuario extends cTable {
	...
	function __construct() {
		...
		// f_Ult_Mod
		$this->f_Ult_Mod = new cField('af_resellers_usuario', 'af_resellers_usuario', 'x_f_Ult_Mod', 'f_Ult_Mod', '`f_Ult_Mod`', 'DATE_FORMAT(`f_Ult_Mod`, \'%d/%m/%Y\')', 135, 9, FALSE, '`f_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
   ...
   // Common render codes
	...
	function Row_Updated($rsold, &$rsnew) {
		update_sql('update_uf_resellers_usuario', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rsold[0], $rsold[1]));
	...
	function Row_Deleting(&$rs) {
		update_sql('update_uf_resellers_usuario', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rs[0], $rs[1]));
		// Enter your code here
		// To cancel, set return value to False
