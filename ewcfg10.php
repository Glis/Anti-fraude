...
define("EW_PROJECT_NAME", "Antifraude_PHPMaker", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'F69njbewjDCt7n4h', TRUE); // Random key for encryption
...
define("EW_CONN_PASS", '0000', TRUE);
define("EW_CONN_DB", 'netuno', TRUE);
