...
class caf_umb_destinos extends cTable {
	...
	function __construct() {
		...
		// f_Ult_Mod
		$this->f_Ult_Mod = new cField('af_umb_destinos', 'af_umb_destinos', 'x_f_Ult_Mod', 'f_Ult_Mod', '`f_Ult_Mod`', 'DATE_FORMAT(`f_Ult_Mod`, \'%d/%m/%Y\')', 135, 9, FALSE, '`f_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
   ...
   // Common render codes
	...
	function Row_Updated($rsold, &$rsnew) {
		update_sql('update_uf_umb_destinos', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rsold[0]));
	...
	function Row_Deleting(&$rs) {
		update_sql('update_uf_umb_destinos', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rs[0]));
		// Enter your code here
		// To cancel, set return value to False
