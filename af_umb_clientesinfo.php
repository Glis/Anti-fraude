...
$af_umb_clientes = NULL;

//
// Table class for af_umb_clientes
//
class caf_umb_clientes extends cTable {
	var $c_IDestino;
	var $c_IReseller;
	var $c_ICliente;
	var $q_MinAl_Cli;
	...
	function __construct() {
		...
		$this->TableVar = 'af_umb_clientes';
		$this->TableName = 'af_umb_clientes';
		...
		// c_IDestino
		$this->c_IDestino = new cField('af_umb_clientes', 'af_umb_clientes', 'x_c_IDestino', 'c_IDestino', '`c_IDestino`', '`c_IDestino`', 200, -1, FALSE, '`c_IDestino`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_IDestino'] = &$this->c_IDestino;

		// c_IReseller
		$this->c_IReseller = new cField('af_umb_clientes', 'af_umb_clientes', 'x_c_IReseller', 'c_IReseller', '`c_IReseller`', '`c_IReseller`', 200, -1, FALSE, '`c_IReseller`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_IReseller'] = &$this->c_IReseller;

		// c_ICliente
		$this->c_ICliente = new cField('af_umb_clientes', 'af_umb_clientes', 'x_c_ICliente', 'c_ICliente', '`c_ICliente`', '`c_ICliente`', 200, -1, FALSE, '`c_ICliente`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_ICliente'] = &$this->c_ICliente;

		// q_MinAl_Cli
		$this->q_MinAl_Cli = new cField('af_umb_clientes', 'af_umb_clientes', 'x_q_MinAl_Cli', 'q_MinAl_Cli', '`q_MinAl_Cli`', '`q_MinAl_Cli`', 3, -1, FALSE, '`q_MinAl_Cli`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->q_MinAl_Cli->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['q_MinAl_Cli'] = &$this->q_MinAl_Cli;

		// q_MinCu_Cli
		$this->q_MinCu_Cli = new cField('af_umb_clientes', 'af_umb_clientes', 'x_q_MinCu_Cli', 'q_MinCu_Cli', '`q_MinCu_Cli`', '`q_MinCu_Cli`', 3, -1, FALSE, '`q_MinCu_Cli`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->q_MinCu_Cli->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['q_MinCu_Cli'] = &$this->q_MinCu_Cli;

		// f_Ult_Mod
		$this->f_Ult_Mod = new cField('af_umb_clientes', 'af_umb_clientes', 'x_f_Ult_Mod', 'f_Ult_Mod', '`f_Ult_Mod`', 'DATE_FORMAT(`f_Ult_Mod`, \'%d/%m/%Y\')', 135, 9, FALSE, '`f_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->f_Ult_Mod->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['f_Ult_Mod'] = &$this->f_Ult_Mod;

		// c_Usuario_Ult_Mod
		$this->c_Usuario_Ult_Mod = new cField('af_umb_clientes', 'af_umb_clientes', 'x_c_Usuario_Ult_Mod', 'c_Usuario_Ult_Mod', '`c_Usuario_Ult_Mod`', '`c_Usuario_Ult_Mod`', 200, -1, FALSE, '`c_Usuario_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`af_umb_clientes`";
	...
	function SqlKeyFilter() {
		return "`c_IDestino` = '@c_IDestino@' AND `c_IReseller` = '@c_IReseller@' AND `c_ICliente` = '@c_ICliente@'";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "af_umb_clienteslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("af_umb_clientesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("af_umb_clientesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "af_umb_clientesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("af_umb_clientesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("af_umb_clientesadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("af_umb_clientesdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function Row_Updated($rsold, &$rsnew) {
		update_sql('update_uf_umb_clientes', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rsold[0], $rsold[1], $rsold[2]));
		//echo "Row Updated";
	}
	...
	function Row_Deleting(&$rs) {
		update_sql('update_uf_umb_clientes', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rs[0], $rs[1], $rs[2]));
