...
$af_acc_clientes_edit = NULL; // Initialize page object first

class caf_acc_clientes_edit extends caf_acc_clientes {
	...
	// Page object name
	var $PageObjName = 'af_acc_clientes_edit';
	...
	function Page_Main() {
		...
		if ($this->cl_Accion->CurrentValue == "")
			$this->Page_Terminate("af_acc_clienteslist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($af_acc_clientes_edit)) $af_acc_clientes_edit = new caf_acc_clientes_edit();

// Page init
$af_acc_clientes_edit->Page_Init();

// Page main
$af_acc_clientes_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_acc_clientes_edit->Page_Render();
?>
...
// Page object
var af_acc_clientes_edit = new ew_Page("af_acc_clientes_edit");
af_acc_clientes_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = af_acc_clientes_edit.PageID; // For backward compatibility

// Form object
var faf_acc_clientesedit = new ew_Form("faf_acc_clientesedit");

// Validate form
faf_acc_clientesedit.Validate = function() {
...
faf_acc_clientesedit.Form_CustomValidate = 
...
faf_acc_clientesedit.ValidateRequired = true;
<?php } else { ?>
faf_acc_clientesedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faf_acc_clientesedit.Lists["x_cl_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_clientesedit.Lists["x_t_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_clientesedit.Lists["x_c_IReseller"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_clientesedit.Lists["x_c_ICClass"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $af_acc_clientes_edit->ShowPageHeader(); ?>
<?php
$af_acc_clientes_edit->ShowMessage();
?>
<form name="faf_acc_clientesedit" id="faf_acc_clientesedit" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="af_acc_clientes">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="k_hash" id="k_hash" value="<?php echo $af_acc_clientes_edit->HashValue ?>">
<div id="page_title"> - Editar</div>
<table class="ewGrid"><tr><td>
<table id="tbl_af_acc_clientesedit" class="table table-bordered table-striped">
...
<?php echo $af_acc_clientes->cl_Accion->EditValue ?></span>
</span>
<input type="hidden" data-field="x_cl_Accion" name="x_cl_Accion" id="x_cl_Accion" value="<?php echo ew_HtmlEncode($af_acc_clientes->cl_Accion->CurrentValue) ?>">
...
<?php echo $af_acc_clientes->t_Accion->EditValue ?></span>
</span>
<input type="hidden" data-field="x_t_Accion" name="x_t_Accion" id="x_t_Accion" value="<?php echo ew_HtmlEncode($af_acc_clientes->t_Accion->CurrentValue) ?>">
...
<?php echo $af_acc_clientes->c_IReseller->EditValue ?></span>
</span>
<input type="hidden" data-field="x_c_IReseller" name="x_c_IReseller" id="x_c_IReseller" value="<?php echo ew_HtmlEncode($af_acc_clientes->c_IReseller->CurrentValue) ?>">
...
<?php echo $af_acc_clientes->c_ICClass->EditValue ?></span>
</span>
<input type="hidden" data-field="x_c_ICClass" name="x_c_ICClass" id="x_c_ICClass" value="<?php echo ew_HtmlEncode($af_acc_clientes->c_ICClass->CurrentValue) ?>">
...
<input class="form-control" type="text" data-field="x_x_DirCorreo" name="x_x_DirCorreo" id="x_x_DirCorreo" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($af_acc_clientes->x_DirCorreo->PlaceHolder) ?>" value="<?php echo $af_acc_clientes->x_DirCorreo->EditValue ?>"<?php echo $af_acc_clientes->x_DirCorreo->EditAttributes() ?>>
</span>
...
<?php if ($af_acc_clientes->x_Titulo->Visible) { // x_Titulo ?>
	<tr id="r_x_Titulo">
		<td>
			...
			<span id="elh_af_acc_clientes_x_Titulo"><?php echo $af_acc_clientes->x_Titulo->FldCaption() ?></span></td>
...
<?php if ($af_acc_clientes->x_Mensaje->Visible) { // x_Mensaje ?>
	<tr id="r_x_Mensaje">
		<td>
			...
			<span id="elh_af_acc_clientes_x_Mensaje"><?php echo $af_acc_clientes->x_Mensaje->FldCaption() ?></span></td>
...
<?php if ($af_acc_clientes->UpdateConflict == "U") { // Record already updated by other user ?>
...
<script type="text/javascript">
faf_acc_clientesedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$af_acc_clientes_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$af_acc_clientes_edit->Page_Terminate();
?>
