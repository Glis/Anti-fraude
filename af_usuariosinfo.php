...
class caf_usuarios extends cTable {
   ...
   // Common render codes
	...
	function Row_Updated($rsold, &$rsnew) {
		update_sql('update_uf_usuarios', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rsold[0]));
	...
	function Row_Deleting(&$rs) {
		update_sql('update_uf_usuarios', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rs[0]));
		// Enter your code here
		// To cancel, set return value to False
