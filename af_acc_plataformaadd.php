...
$af_acc_plataforma_add = NULL; // Initialize page object first

class caf_acc_plataforma_add extends caf_acc_plataforma {
	...
	// Page object name
	var $PageObjName = 'af_acc_plataforma_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "af_acc_plataformaview.php")
...
// Create page object
if (!isset($af_acc_plataforma_add)) $af_acc_plataforma_add = new caf_acc_plataforma_add();

// Page init
$af_acc_plataforma_add->Page_Init();

// Page main
$af_acc_plataforma_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_acc_plataforma_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var af_acc_plataforma_add = new ew_Page("af_acc_plataforma_add");
af_acc_plataforma_add.PageID = "add"; // Page ID
var EW_PAGE_ID = af_acc_plataforma_add.PageID; // For backward compatibility

// Form object
var faf_acc_plataformaadd = new ew_Form("faf_acc_plataformaadd");

// Validate form
faf_acc_plataformaadd.Validate = function() {
...
faf_acc_plataformaadd.Form_CustomValidate = 
...
faf_acc_plataformaadd.ValidateRequired = true;
<?php } else { ?>
faf_acc_plataformaadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faf_acc_plataformaadd.Lists["x_cl_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_plataformaadd.Lists["x_t_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $af_acc_plataforma_add->ShowPageHeader(); ?>
<?php
$af_acc_plataforma_add->ShowMessage();
?>
<form name="faf_acc_plataformaadd" id="faf_acc_plataformaadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="af_acc_plataforma">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_af_acc_plataformaadd" class="table table-bordered table-striped">
...
if (is_array($af_acc_plataforma->cl_Accion->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($af_acc_plataforma->cl_Accion->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
faf_acc_plataformaadd.Lists["x_cl_Accion"].Options = <?php echo (is_array($af_acc_plataforma->cl_Accion->EditValue)) ? ew_ArrayToJson($af_acc_plataforma->cl_Accion->EditValue, 1) : "[]" ?>;
</script>
</span>
...
if (is_array($af_acc_plataforma->t_Accion->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($af_acc_plataforma->t_Accion->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
faf_acc_plataformaadd.Lists["x_t_Accion"].Options = <?php echo (is_array($af_acc_plataforma->t_Accion->EditValue)) ? ew_ArrayToJson($af_acc_plataforma->t_Accion->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
faf_acc_plataformaadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$af_acc_plataforma_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$af_acc_plataforma_add->Page_Terminate();
?>
