...
class caf_umb_resellers extends cTable {
	...
	function __construct() {
		...
		// f_Ult_Mod
		$this->f_Ult_Mod = new cField('af_umb_resellers', 'af_umb_resellers', 'x_f_Ult_Mod', 'f_Ult_Mod', '`f_Ult_Mod`', 'DATE_FORMAT(`f_Ult_Mod`, \'%d/%m/%Y\')', 135, 7, FALSE, '`f_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
