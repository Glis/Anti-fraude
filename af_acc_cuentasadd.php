...
<select data-field="x_cl_Accion" id="x_cl_Accion" name="x_cl_Accion"<?php echo $af_acc_cuentas->cl_Accion->EditAttributes() ?>>
<?php
...
<select data-field="x_t_Accion" id="x_t_Accion" name="x_t_Accion"<?php echo $af_acc_cuentas->t_Accion->EditAttributes() ?>>
<?php
...
<select data-field="x_c_IReseller" id="x_c_IReseller" name="x_c_IReseller"<?php echo $af_acc_cuentas->c_IReseller->EditAttributes() ?>>
<?php
...
<select data-field="x_c_ICClass" id="x_c_ICClass" name="x_c_ICClass"<?php echo $af_acc_cuentas->c_ICClass->EditAttributes() ?>>
<?php
...
<input type="email" data-field="x_x_DirCorreo" name="x_x_DirCorreo" id="x_x_DirCorreo" size="30" maxlength="100" placeholder="example@example.com<?php //echo ew_HtmlEncode($af_acc_cuentas->x_DirCorreo->PlaceHolder) ?>" value="<?php echo $af_acc_cuentas->x_DirCorreo->EditValue ?>"<?php echo $af_acc_cuentas->x_DirCorreo->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_x_Titulo" name="x_x_Titulo" id="x_x_Titulo" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($af_acc_cuentas->x_Titulo->PlaceHolder) ?>" value="<?php echo $af_acc_cuentas->x_Titulo->EditValue ?>"<?php echo $af_acc_cuentas->x_Titulo->EditAttributes() ?>>
</span>
...
<textarea data-field="x_x_Mensaje" name="x_x_Mensaje" id="x_x_Mensaje" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($af_acc_cuentas->x_Mensaje->PlaceHolder) ?>"<?php echo $af_acc_cuentas->x_Mensaje->EditAttributes() ?>><?php echo $af_acc_cuentas->x_Mensaje->EditValue ?></textarea>
</span>
