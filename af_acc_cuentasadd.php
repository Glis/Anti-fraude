...
<input type="text" data-field="x_c_IReseller" name="x_c_IReseller" id="x_c_IReseller" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($af_acc_cuentas->c_IReseller->PlaceHolder) ?>" value="<?php echo $af_acc_cuentas->c_IReseller->EditValue ?>"<?php echo $af_acc_cuentas->c_IReseller->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_c_ICClass" name="x_c_ICClass" id="x_c_ICClass" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($af_acc_cuentas->c_ICClass->PlaceHolder) ?>" value="<?php echo $af_acc_cuentas->c_ICClass->EditValue ?>"<?php echo $af_acc_cuentas->c_ICClass->EditAttributes() ?>>
</span>
