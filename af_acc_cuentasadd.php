...
<?php if ($af_acc_cuentas->x_Titulo->Visible) { // x_Titulo ?>
	<tr id="r_x_Titulo">
		<td>
			...
			<span id="elh_af_acc_cuentas_x_Titulo"><?php echo $af_acc_cuentas->x_Titulo->FldCaption() ?></span></td>
...
<?php if ($af_acc_cuentas->x_Mensaje->Visible) { // x_Mensaje ?>
	<tr id="r_x_Mensaje">
		<td>
			...
			<span id="elh_af_acc_cuentas_x_Mensaje"><?php echo $af_acc_cuentas->x_Mensaje->FldCaption() ?></span></td>
