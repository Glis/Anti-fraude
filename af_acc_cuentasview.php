...
$af_acc_cuentas_view = NULL; // Initialize page object first

class caf_acc_cuentas_view extends caf_acc_cuentas {
	...
	// Page object name
	var $PageObjName = 'af_acc_cuentas_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["cl_Accion"] <> "") {
				...
				$sReturnUrl = "af_acc_cuentaslist.php"; // Return to list
			}
			if (@$_GET["t_Accion"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "af_acc_cuentaslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "af_acc_cuentaslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($af_acc_cuentas_view)) $af_acc_cuentas_view = new caf_acc_cuentas_view();

// Page init
$af_acc_cuentas_view->Page_Init();

// Page main
$af_acc_cuentas_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_acc_cuentas_view->Page_Render();
?>
...
// Page object
var af_acc_cuentas_view = new ew_Page("af_acc_cuentas_view");
af_acc_cuentas_view.PageID = "view"; // Page ID
var EW_PAGE_ID = af_acc_cuentas_view.PageID; // For backward compatibility

// Form object
var faf_acc_cuentasview = new ew_Form("faf_acc_cuentasview");

// Form_CustomValidate event
faf_acc_cuentasview.Form_CustomValidate = 
...
faf_acc_cuentasview.ValidateRequired = true;
<?php } else { ?>
faf_acc_cuentasview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faf_acc_cuentasview.Lists["x_cl_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_cuentasview.Lists["x_t_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_cuentasview.Lists["x_c_IReseller"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_cuentasview.Lists["x_c_ICClass"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $af_acc_cuentas_view->ExportOptions->Render("body") ?>
<?php if (!$af_acc_cuentas_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($af_acc_cuentas_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $af_acc_cuentas_view->ShowPageHeader(); ?>
<?php
$af_acc_cuentas_view->ShowMessage();
?>
<form name="faf_acc_cuentasview" id="faf_acc_cuentasview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="af_acc_cuentas">
<table class="ewGrid"><tr><td>
<table id="tbl_af_acc_cuentasview" class="table table-bordered table-striped">
<?php if ($af_acc_cuentas->cl_Accion->Visible) { // cl_Accion ?>
	<tr id="r_cl_Accion">
		<td><span id="elh_af_acc_cuentas_cl_Accion"><?php echo $af_acc_cuentas->cl_Accion->FldCaption() ?></span></td>
...
<?php echo $af_acc_cuentas->cl_Accion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_cuentas->t_Accion->Visible) { // t_Accion ?>
	<tr id="r_t_Accion">
		<td><span id="elh_af_acc_cuentas_t_Accion"><?php echo $af_acc_cuentas->t_Accion->FldCaption() ?></span></td>
...
<?php echo $af_acc_cuentas->t_Accion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_cuentas->c_IReseller->Visible) { // c_IReseller ?>
	<tr id="r_c_IReseller">
		<td><span id="elh_af_acc_cuentas_c_IReseller"><?php echo $af_acc_cuentas->c_IReseller->FldCaption() ?></span></td>
...
<?php echo $af_acc_cuentas->c_IReseller->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_cuentas->c_ICClass->Visible) { // c_ICClass ?>
	<tr id="r_c_ICClass">
		<td><span id="elh_af_acc_cuentas_c_ICClass"><?php echo $af_acc_cuentas->c_ICClass->FldCaption() ?></span></td>
...
<?php echo $af_acc_cuentas->c_ICClass->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $af_acc_cuentas->x_DirCorreo->ViewAttributes() ?>>
<?php echo $af_acc_cuentas->x_DirCorreo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $af_acc_cuentas->x_Titulo->ViewAttributes() ?>>
<?php echo $af_acc_cuentas->x_Titulo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $af_acc_cuentas->x_Mensaje->ViewAttributes() ?>>
<?php echo $af_acc_cuentas->x_Mensaje->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_cuentas->f_Ult_Mod->Visible) { // f_Ult_Mod ?>
	<tr id="r_f_Ult_Mod">
		<td><span id="elh_af_acc_cuentas_f_Ult_Mod"><?php echo $af_acc_cuentas->f_Ult_Mod->FldCaption() ?></span></td>
		<td<?php echo $af_acc_cuentas->f_Ult_Mod->CellAttributes() ?>>
<span id="el_af_acc_cuentas_f_Ult_Mod" class="control-group">
<span<?php echo $af_acc_cuentas->f_Ult_Mod->ViewAttributes() ?>>
<?php echo $af_acc_cuentas->f_Ult_Mod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_cuentas->c_Usuario_Ult_Mod->Visible) { // c_Usuario_Ult_Mod ?>
	<tr id="r_c_Usuario_Ult_Mod">
		<td><span id="elh_af_acc_cuentas_c_Usuario_Ult_Mod"><?php echo $af_acc_cuentas->c_Usuario_Ult_Mod->FldCaption() ?></span></td>
		<td<?php echo $af_acc_cuentas->c_Usuario_Ult_Mod->CellAttributes() ?>>
<span id="el_af_acc_cuentas_c_Usuario_Ult_Mod" class="control-group">
<span<?php echo $af_acc_cuentas->c_Usuario_Ult_Mod->ViewAttributes() ?>>
<?php echo $af_acc_cuentas->c_Usuario_Ult_Mod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
faf_acc_cuentasview.Init();
</script>
<?php
$af_acc_cuentas_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$af_acc_cuentas_view->Page_Terminate();
?>
