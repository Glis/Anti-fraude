...
class caf_acc_cclass_list extends caf_acc_cclass {
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" href=\"\" onclick=\"ew_SubmitSelected(document.faf_acc_cclasslist, '" . $this->MultiDeleteUrl . "');return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = (TRUE);
...
var faf_acc_cclasslistsrch = new ew_Form("faf_acc_cclasslistsrch");
</script>
<script type="text/javascript">
...
?>
<?php if ($af_acc_cclass->Export == "" && $af_acc_cclass->CurrentAction == "") { ?>
<form name="faf_acc_cclasslistsrch" id="faf_acc_cclasslistsrch" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>">
<div class="accordion ewDisplayTable ewSearchTable" id="faf_acc_cclasslistsrch_SearchGroup">
	<div class="accordion-group">
		<div class="accordion-heading">
<a class="accordion-toggle" data-toggle="collapse" data-parent="#faf_acc_cclasslistsrch_SearchGroup" href="#faf_acc_cclasslistsrch_SearchBody"><?php echo $Language->Phrase("Search") ?></a>
		</div>
		<div id="faf_acc_cclasslistsrch_SearchBody" class="accordion-body collapse in">
			<div class="accordion-inner">
<div id="faf_acc_cclasslistsrch_SearchPanel">
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="input-large" value="<?php echo ew_HtmlEncode($af_acc_cclass_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Search")) ?>">
	<button class="btn btn-primary ewButton" name="btnsubmit" id="btnsubmit" type="submit"><?php echo $Language->Phrase("QuickSearchBtn") ?></button>
	</div>
	</div>
	<div class="btn-group ewButtonGroup">
	<a class="btn ewShowAll" href="<?php echo $af_acc_cclass_list->PageUrl() ?>cmd=reset"><?php echo $Language->Phrase("ShowAll") ?></a>
	<?php if ($af_acc_cclass_list->SearchWhere <> "" && $af_acc_cclass_list->TotalRecs > 0) { ?>
	<a class="btn ewHideHighlight" href="javascript:void(0);" onclick="ewForms(this).ToggleHighlight(this, '<?php echo $af_acc_cclass->HighlightName() ?>');"><?php echo $Language->Phrase("HideHighlight") ?></a>
	<?php } ?>
	</div>
</div>
<div id="xsr_2" class="ewRow">
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="="<?php if ($af_acc_cclass_list->BasicSearch->getType() == "=") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("ExactPhrase") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="AND"<?php if ($af_acc_cclass_list->BasicSearch->getType() == "AND") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AllWord") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="OR"<?php if ($af_acc_cclass_list->BasicSearch->getType() == "OR") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AnyWord") ?></label>
</div>
</div>
</div>
			</div>
...
<?php if ($af_acc_cclass->c_IReseller->Visible) { // c_IReseller ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $af_acc_cclass->SortUrl($af_acc_cclass->c_IReseller) ?>',2);"><div id="elh_af_acc_cclass_c_IReseller" class="af_acc_cclass_c_IReseller">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $af_acc_cclass->c_IReseller->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($af_acc_cclass->c_IReseller->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($af_acc_cclass->c_IReseller->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($af_acc_cclass->c_ICClass->Visible) { // c_ICClass ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $af_acc_cclass->SortUrl($af_acc_cclass->c_ICClass) ?>',2);"><div id="elh_af_acc_cclass_c_ICClass" class="af_acc_cclass_c_ICClass">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $af_acc_cclass->c_ICClass->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($af_acc_cclass->c_ICClass->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($af_acc_cclass->c_ICClass->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
