...
class caf_config_reportes extends cTable {
	...
	function __construct() {
		...
		// p_Destino
		$this->p_Destino = new cField('af_config_reportes', 'af_config_reportes', 'x_p_Destino', 'p_Destino', '`p_Destino`', '`p_Destino`', 3, -1, FALSE, '`p_Destino`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// f_Ult_Mod
		$this->f_Ult_Mod = new cField('af_config_reportes', 'af_config_reportes', 'x_f_Ult_Mod', 'f_Ult_Mod', '`f_Ult_Mod`', 'DATE_FORMAT(`f_Ult_Mod`, \'%d/%m/%Y\')', 135, 9, FALSE, '`f_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
   ...
   // Common render codes
	...
	function Row_Updated($rsold, &$rsnew) {
		update_sql('update_uf_config_reportes', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rsold[0]));
	...
	function Row_Deleting(&$rs) {
		update_sql('update_uf_config_reportes', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rs[0]));
		// Enter your code here
		// To cancel, set return value to False
