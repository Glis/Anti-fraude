...
//
// Table class for af_acc_clientes
//
class caf_acc_clientes extends cTable {
	var $cl_Accion;
	var $t_Accion;
	var $c_IReseller;
	var $c_ICClass;
	...
	function __construct() {
		...
		$this->TableVar = 'af_acc_clientes';
		$this->TableName = 'af_acc_clientes';
		...
		// cl_Accion
		$this->cl_Accion = new cField('af_acc_clientes', 'af_acc_clientes', 'x_cl_Accion', 'cl_Accion', '`cl_Accion`', '`cl_Accion`', 3, -1, FALSE, '`EV__cl_Accion`', TRUE, TRUE, TRUE, 'FORMATTED TEXT');
		$this->fields['cl_Accion'] = &$this->cl_Accion;

		// t_Accion
		$this->t_Accion = new cField('af_acc_clientes', 'af_acc_clientes', 'x_t_Accion', 't_Accion', '`t_Accion`', '`t_Accion`', 3, -1, FALSE, '`t_Accion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['t_Accion'] = &$this->t_Accion;

		// c_IReseller
		$this->c_IReseller = new cField('af_acc_clientes', 'af_acc_clientes', 'x_c_IReseller', 'c_IReseller', '`c_IReseller`', '`c_IReseller`', 200, -1, FALSE, '`c_IReseller`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_IReseller'] = &$this->c_IReseller;

		// c_ICClass
		$this->c_ICClass = new cField('af_acc_clientes', 'af_acc_clientes', 'x_c_ICClass', 'c_ICClass', '`c_ICClass`', '`c_ICClass`', 200, -1, FALSE, '`c_ICClass`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_ICClass'] = &$this->c_ICClass;

		// x_DirCorreo
		$this->x_DirCorreo = new cField('af_acc_clientes', 'af_acc_clientes', 'x_x_DirCorreo', 'x_DirCorreo', '`x_DirCorreo`', '`x_DirCorreo`', 200, -1, FALSE, '`x_DirCorreo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['x_DirCorreo'] = &$this->x_DirCorreo;

		// x_Titulo
		$this->x_Titulo = new cField('af_acc_clientes', 'af_acc_clientes', 'x_x_Titulo', 'x_Titulo', '`x_Titulo`', '`x_Titulo`', 200, -1, FALSE, '`x_Titulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['x_Titulo'] = &$this->x_Titulo;

		// x_Mensaje
		$this->x_Mensaje = new cField('af_acc_clientes', 'af_acc_clientes', 'x_x_Mensaje', 'x_Mensaje', '`x_Mensaje`', '`x_Mensaje`', 201, -1, FALSE, '`x_Mensaje`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// c_Usuario_Ult_Mod
		$this->c_Usuario_Ult_Mod = new cField('af_acc_clientes', 'af_acc_clientes', 'x_c_Usuario_Ult_Mod', 'c_Usuario_Ult_Mod', '`c_Usuario_Ult_Mod`', '`c_Usuario_Ult_Mod`', 200, -1, FALSE, '`c_Usuario_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlSelectList() { // Select for List page
		return "SELECT * FROM (" .
			"SELECT *, (SELECT `rv_Meaning` FROM `af_dominios` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`rv_Low_Value` = `af_acc_clientes`.`cl_Accion` LIMIT 1) AS `EV__cl_Accion` FROM `af_acc_clientes`" .
			") `EW_TMP_TABLE`";
	}
	...
	// Update Table
	var $UpdateTable = "`af_acc_clientes`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "af_acc_clienteslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("af_acc_clientesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("af_acc_clientesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "af_acc_clientesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("af_acc_clientesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("af_acc_clientesadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("af_acc_clientesdelete.php", $this->UrlParm());
	}
