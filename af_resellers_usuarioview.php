...
$af_resellers_usuario_view = NULL; // Initialize page object first

class caf_resellers_usuario_view extends caf_resellers_usuario {
	...
	// Page object name
	var $PageObjName = 'af_resellers_usuario_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["c_Usuario"] <> "") {
				...
				$sReturnUrl = "af_resellers_usuariolist.php"; // Return to list
			}
			if (@$_GET["c_IReseller"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "af_resellers_usuariolist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "af_resellers_usuariolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($af_resellers_usuario_view)) $af_resellers_usuario_view = new caf_resellers_usuario_view();

// Page init
$af_resellers_usuario_view->Page_Init();

// Page main
$af_resellers_usuario_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_resellers_usuario_view->Page_Render();
?>
...
// Page object
var af_resellers_usuario_view = new ew_Page("af_resellers_usuario_view");
af_resellers_usuario_view.PageID = "view"; // Page ID
var EW_PAGE_ID = af_resellers_usuario_view.PageID; // For backward compatibility

// Form object
var faf_resellers_usuarioview = new ew_Form("faf_resellers_usuarioview");

// Form_CustomValidate event
faf_resellers_usuarioview.Form_CustomValidate = 
...
faf_resellers_usuarioview.ValidateRequired = true;
<?php } else { ?>
faf_resellers_usuarioview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faf_resellers_usuarioview.Lists["x_c_Usuario"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_resellers_usuarioview.Lists["x_c_IReseller"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php } ?>
<?php
	foreach ($af_resellers_usuario_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $af_resellers_usuario_view->ShowPageHeader(); ?>
<?php
$af_resellers_usuario_view->ShowMessage();
?>
<form name="faf_resellers_usuarioview" id="faf_resellers_usuarioview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="af_resellers_usuario">
<table class="ewGrid"><tr><td>
<table id="tbl_af_resellers_usuarioview" class="table table-bordered table-striped">
<?php if ($af_resellers_usuario->c_Usuario->Visible) { // c_Usuario ?>
	<tr id="r_c_Usuario">
		<td><span id="elh_af_resellers_usuario_c_Usuario"><?php echo $af_resellers_usuario->c_Usuario->FldCaption() ?></span></td>
...
<?php echo $af_resellers_usuario->c_Usuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_resellers_usuario->c_IReseller->Visible) { // c_IReseller ?>
	<tr id="r_c_IReseller">
		<td><span id="elh_af_resellers_usuario_c_IReseller"><?php echo $af_resellers_usuario->c_IReseller->FldCaption() ?></span></td>
...
<?php echo $af_resellers_usuario->c_IReseller->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_resellers_usuario->f_Ult_Mod->Visible) { // f_Ult_Mod ?>
	<tr id="r_f_Ult_Mod">
		<td><span id="elh_af_resellers_usuario_f_Ult_Mod"><?php echo $af_resellers_usuario->f_Ult_Mod->FldCaption() ?></span></td>
		<td<?php echo $af_resellers_usuario->f_Ult_Mod->CellAttributes() ?>>
<span id="el_af_resellers_usuario_f_Ult_Mod" class="control-group">
<span<?php echo $af_resellers_usuario->f_Ult_Mod->ViewAttributes() ?>>
<?php echo $af_resellers_usuario->f_Ult_Mod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_resellers_usuario->c_Usuario_Ult_Mod->Visible) { // c_Usuario_Ult_Mod ?>
	<tr id="r_c_Usuario_Ult_Mod">
		<td><span id="elh_af_resellers_usuario_c_Usuario_Ult_Mod"><?php echo $af_resellers_usuario->c_Usuario_Ult_Mod->FldCaption() ?></span></td>
		<td<?php echo $af_resellers_usuario->c_Usuario_Ult_Mod->CellAttributes() ?>>
<span id="el_af_resellers_usuario_c_Usuario_Ult_Mod" class="control-group">
<span<?php echo $af_resellers_usuario->c_Usuario_Ult_Mod->ViewAttributes() ?>>
<?php echo $af_resellers_usuario->c_Usuario_Ult_Mod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
faf_resellers_usuarioview.Init();
</script>
<?php
$af_resellers_usuario_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$af_resellers_usuario_view->Page_Terminate();
?>
