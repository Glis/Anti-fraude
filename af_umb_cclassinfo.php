...
//
// Table class for af_umb_cclass
//
class caf_umb_cclass extends cTable {
	var $c_IDestino;
	var $c_IReseller;
	var $c_ICClass;
	var $q_MinAl_CClass;
	...
	function __construct() {
		...
		$this->TableVar = 'af_umb_cclass';
		$this->TableName = 'af_umb_cclass';
		...
		// c_IDestino
		$this->c_IDestino = new cField('af_umb_cclass', 'af_umb_cclass', 'x_c_IDestino', 'c_IDestino', '`c_IDestino`', '`c_IDestino`', 200, -1, FALSE, '`c_IDestino`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_IDestino'] = &$this->c_IDestino;

		// c_IReseller
		$this->c_IReseller = new cField('af_umb_cclass', 'af_umb_cclass', 'x_c_IReseller', 'c_IReseller', '`c_IReseller`', '`c_IReseller`', 200, -1, FALSE, '`c_IReseller`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_IReseller'] = &$this->c_IReseller;

		// c_ICClass
		$this->c_ICClass = new cField('af_umb_cclass', 'af_umb_cclass', 'x_c_ICClass', 'c_ICClass', '`c_ICClass`', '`c_ICClass`', 200, -1, FALSE, '`c_ICClass`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_ICClass'] = &$this->c_ICClass;

		// q_MinAl_CClass
		$this->q_MinAl_CClass = new cField('af_umb_cclass', 'af_umb_cclass', 'x_q_MinAl_CClass', 'q_MinAl_CClass', '`q_MinAl_CClass`', '`q_MinAl_CClass`', 3, -1, FALSE, '`q_MinAl_CClass`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->q_MinAl_CClass->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['q_MinAl_CClass'] = &$this->q_MinAl_CClass;

		// q_MinCu_CClass
		$this->q_MinCu_CClass = new cField('af_umb_cclass', 'af_umb_cclass', 'x_q_MinCu_CClass', 'q_MinCu_CClass', '`q_MinCu_CClass`', '`q_MinCu_CClass`', 3, -1, FALSE, '`q_MinCu_CClass`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->q_MinCu_CClass->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['q_MinCu_CClass'] = &$this->q_MinCu_CClass;

		// f_Ult_Mod
		$this->f_Ult_Mod = new cField('af_umb_cclass', 'af_umb_cclass', 'x_f_Ult_Mod', 'f_Ult_Mod', '`f_Ult_Mod`', 'DATE_FORMAT(`f_Ult_Mod`, \'%d/%m/%Y\')', 135, 9, FALSE, '`f_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->f_Ult_Mod->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['f_Ult_Mod'] = &$this->f_Ult_Mod;

		// c_Usuario_Ult_Mod
		$this->c_Usuario_Ult_Mod = new cField('af_umb_cclass', 'af_umb_cclass', 'x_c_Usuario_Ult_Mod', 'c_Usuario_Ult_Mod', '`c_Usuario_Ult_Mod`', '`c_Usuario_Ult_Mod`', 200, -1, FALSE, '`c_Usuario_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlKeyFilter() {
		return "`c_IDestino` = '@c_IDestino@' AND `c_IReseller` = '@c_IReseller@' AND `c_ICClass` = '@c_ICClass@'";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("af_umb_cclassview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("af_umb_cclassview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "af_umb_cclassadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("af_umb_cclassedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("af_umb_cclassadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("af_umb_cclassdelete.php", $this->UrlParm());
	}
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->c_ICClass->CurrentValue = $key[2];
   ...
   // Common render codes
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->q_MinAl_CClass->Exportable) $Doc->ExportCaption($this->q_MinAl_CClass);
				if ($this->q_MinCu_CClass->Exportable) $Doc->ExportCaption($this->q_MinCu_CClass);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->q_MinAl_CClass->Exportable) $Doc->ExportField($this->q_MinAl_CClass);
					if ($this->q_MinCu_CClass->Exportable) $Doc->ExportField($this->q_MinCu_CClass);
	...
	function Row_Updated($rsold, &$rsnew) {
		update_sql('update_uf_umb_cclass', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rsold[0], $rsold[1], $rsold[2]));
	...
	function Row_Deleting(&$rs) {
		update_sql('update_uf_umb_cclass', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rs[0], $rs[1], $rs[2]));
