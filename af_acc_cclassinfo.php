...
class caf_acc_cclass extends cTable {
	...
	function __construct() {
		...
		// f_Ult_Mod
		$this->f_Ult_Mod = new cField('af_acc_cclass', 'af_acc_cclass', 'x_f_Ult_Mod', 'f_Ult_Mod', '`f_Ult_Mod`', 'DATE_FORMAT(`f_Ult_Mod`, \'%d/%m/%Y\')', 135, 9, FALSE, '`f_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
