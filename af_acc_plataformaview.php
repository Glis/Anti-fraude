...
$af_acc_plataforma_view = NULL; // Initialize page object first

class caf_acc_plataforma_view extends caf_acc_plataforma {
	...
	// Page object name
	var $PageObjName = 'af_acc_plataforma_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["cl_Accion"] <> "") {
				...
				$sReturnUrl = "af_acc_plataformalist.php"; // Return to list
			}
			if (@$_GET["t_Accion"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "af_acc_plataformalist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "af_acc_plataformalist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($af_acc_plataforma_view)) $af_acc_plataforma_view = new caf_acc_plataforma_view();

// Page init
$af_acc_plataforma_view->Page_Init();

// Page main
$af_acc_plataforma_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_acc_plataforma_view->Page_Render();
?>
...
// Page object
var af_acc_plataforma_view = new ew_Page("af_acc_plataforma_view");
af_acc_plataforma_view.PageID = "view"; // Page ID
var EW_PAGE_ID = af_acc_plataforma_view.PageID; // For backward compatibility

// Form object
var faf_acc_plataformaview = new ew_Form("faf_acc_plataformaview");

// Form_CustomValidate event
faf_acc_plataformaview.Form_CustomValidate = 
...
faf_acc_plataformaview.ValidateRequired = true;
<?php } else { ?>
faf_acc_plataformaview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faf_acc_plataformaview.Lists["x_cl_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_plataformaview.Lists["x_t_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $af_acc_plataforma_view->ExportOptions->Render("body") ?>
<?php if (!$af_acc_plataforma_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($af_acc_plataforma_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $af_acc_plataforma_view->ShowPageHeader(); ?>
<?php
$af_acc_plataforma_view->ShowMessage();
?>
<form name="faf_acc_plataformaview" id="faf_acc_plataformaview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="af_acc_plataforma">
<table class="ewGrid"><tr><td>
<table id="tbl_af_acc_plataformaview" class="table table-bordered table-striped">
<?php if ($af_acc_plataforma->cl_Accion->Visible) { // cl_Accion ?>
	<tr id="r_cl_Accion">
		<td><span id="elh_af_acc_plataforma_cl_Accion"><?php echo $af_acc_plataforma->cl_Accion->FldCaption() ?></span></td>
...
<?php echo $af_acc_plataforma->cl_Accion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_plataforma->t_Accion->Visible) { // t_Accion ?>
	<tr id="r_t_Accion">
		<td><span id="elh_af_acc_plataforma_t_Accion"><?php echo $af_acc_plataforma->t_Accion->FldCaption() ?></span></td>
...
<?php echo $af_acc_plataforma->t_Accion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $af_acc_plataforma->x_DirCorreo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_plataforma->x_Titulo->Visible) { // x_Titulo ?>
	<tr id="r_x_Titulo">
...
<span<?php echo $af_acc_plataforma->x_Titulo->ViewAttributes() ?>>
<?php echo $af_acc_plataforma->x_Titulo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_plataforma->x_Mensaje->Visible) { // x_Mensaje ?>
	<tr id="r_x_Mensaje">
...
<span<?php echo $af_acc_plataforma->x_Mensaje->ViewAttributes() ?>>
<?php echo $af_acc_plataforma->x_Mensaje->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_plataforma->f_Ult_Mod->Visible) { // f_Ult_Mod ?>
	<tr id="r_f_Ult_Mod">
		<td><span id="elh_af_acc_plataforma_f_Ult_Mod"><?php echo $af_acc_plataforma->f_Ult_Mod->FldCaption() ?></span></td>
		<td<?php echo $af_acc_plataforma->f_Ult_Mod->CellAttributes() ?>>
<span id="el_af_acc_plataforma_f_Ult_Mod" class="control-group">
<span<?php echo $af_acc_plataforma->f_Ult_Mod->ViewAttributes() ?>>
<?php echo $af_acc_plataforma->f_Ult_Mod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_plataforma->c_Usuario_Ult_Mod->Visible) { // c_Usuario_Ult_Mod ?>
	<tr id="r_c_Usuario_Ult_Mod">
		<td><span id="elh_af_acc_plataforma_c_Usuario_Ult_Mod"><?php echo $af_acc_plataforma->c_Usuario_Ult_Mod->FldCaption() ?></span></td>
		<td<?php echo $af_acc_plataforma->c_Usuario_Ult_Mod->CellAttributes() ?>>
<span id="el_af_acc_plataforma_c_Usuario_Ult_Mod" class="control-group">
<span<?php echo $af_acc_plataforma->c_Usuario_Ult_Mod->ViewAttributes() ?>>
<?php echo $af_acc_plataforma->c_Usuario_Ult_Mod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
faf_acc_plataformaview.Init();
</script>
<?php
$af_acc_plataforma_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$af_acc_plataforma_view->Page_Terminate();
?>
