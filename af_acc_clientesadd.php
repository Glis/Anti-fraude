...
<select class="form-control" data-field="x_cl_Accion" id="x_cl_Accion" name="x_cl_Accion"<?php echo $af_acc_clientes->cl_Accion->EditAttributes() ?>>
<?php
...
<select class="form-control" data-field="x_t_Accion" id="x_t_Accion" name="x_t_Accion"<?php echo $af_acc_clientes->t_Accion->EditAttributes() ?>>
<?php
...
<select class="form-control" data-field="x_c_IReseller" id="x_c_IReseller" name="x_c_IReseller"<?php echo $af_acc_clientes->c_IReseller->EditAttributes() ?>>
<?php
...
<select class="form-control" data-field="x_c_ICClass" id="x_c_ICClass" name="x_c_ICClass"<?php echo $af_acc_clientes->c_ICClass->EditAttributes() ?>>
<?php
...
<input class="form-control" type="text" data-field="x_x_DirCorreo" name="x_x_DirCorreo" id="x_x_DirCorreo" size="30" maxlength="100" placeholder="example@example.com<?php //echo ew_HtmlEncode($af_acc_clientes->x_DirCorreo->PlaceHolder) ?>" value="<?php echo $af_acc_clientes->x_DirCorreo->EditValue ?>"<?php echo $af_acc_clientes->x_DirCorreo->EditAttributes() ?>>
</span>
