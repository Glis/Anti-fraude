...
//
// Table class for af_acc_cuentas
//
class caf_acc_cuentas extends cTable {
	var $cl_Accion;
	var $t_Accion;
	var $c_IReseller;
	var $c_ICClass;
	...
	function __construct() {
		...
		$this->TableVar = 'af_acc_cuentas';
		$this->TableName = 'af_acc_cuentas';
		...
		// cl_Accion
		$this->cl_Accion = new cField('af_acc_cuentas', 'af_acc_cuentas', 'x_cl_Accion', 'cl_Accion', '`cl_Accion`', '`cl_Accion`', 3, -1, FALSE, '`cl_Accion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cl_Accion'] = &$this->cl_Accion;

		// t_Accion
		$this->t_Accion = new cField('af_acc_cuentas', 'af_acc_cuentas', 'x_t_Accion', 't_Accion', '`t_Accion`', '`t_Accion`', 3, -1, FALSE, '`t_Accion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['t_Accion'] = &$this->t_Accion;

		// c_IReseller
		$this->c_IReseller = new cField('af_acc_cuentas', 'af_acc_cuentas', 'x_c_IReseller', 'c_IReseller', '`c_IReseller`', '`c_IReseller`', 200, -1, FALSE, '`c_IReseller`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_IReseller'] = &$this->c_IReseller;

		// c_ICClass
		$this->c_ICClass = new cField('af_acc_cuentas', 'af_acc_cuentas', 'x_c_ICClass', 'c_ICClass', '`c_ICClass`', '`c_ICClass`', 200, -1, FALSE, '`c_ICClass`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_ICClass'] = &$this->c_ICClass;

		// x_DirCorreo
		$this->x_DirCorreo = new cField('af_acc_cuentas', 'af_acc_cuentas', 'x_x_DirCorreo', 'x_DirCorreo', '`x_DirCorreo`', '`x_DirCorreo`', 200, -1, FALSE, '`x_DirCorreo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['x_DirCorreo'] = &$this->x_DirCorreo;

		// x_Titulo
		$this->x_Titulo = new cField('af_acc_cuentas', 'af_acc_cuentas', 'x_x_Titulo', 'x_Titulo', '`x_Titulo`', '`x_Titulo`', 200, -1, FALSE, '`x_Titulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['x_Titulo'] = &$this->x_Titulo;

		// x_Mensaje
		$this->x_Mensaje = new cField('af_acc_cuentas', 'af_acc_cuentas', 'x_x_Mensaje', 'x_Mensaje', '`x_Mensaje`', '`x_Mensaje`', 201, -1, FALSE, '`x_Mensaje`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['x_Mensaje'] = &$this->x_Mensaje;

		// f_Ult_Mod
		$this->f_Ult_Mod = new cField('af_acc_cuentas', 'af_acc_cuentas', 'x_f_Ult_Mod', 'f_Ult_Mod', '`f_Ult_Mod`', 'DATE_FORMAT(`f_Ult_Mod`, \'%d/%m/%Y\')', 135, 9, FALSE, '`f_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->f_Ult_Mod->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['f_Ult_Mod'] = &$this->f_Ult_Mod;

		// c_Usuario_Ult_Mod
		$this->c_Usuario_Ult_Mod = new cField('af_acc_cuentas', 'af_acc_cuentas', 'x_c_Usuario_Ult_Mod', 'c_Usuario_Ult_Mod', '`c_Usuario_Ult_Mod`', '`c_Usuario_Ult_Mod`', 200, -1, FALSE, '`c_Usuario_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`af_acc_cuentas`";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("af_acc_cuentasview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("af_acc_cuentasview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "af_acc_cuentasadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("af_acc_cuentasedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("af_acc_cuentasadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("af_acc_cuentasdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function Row_Updated($rsold, &$rsnew) {
		update_sql('update_uf_acc_cuentas', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rsold[0], $rsold[1], $rsold[2], $rsold[3]));
		//echo "Row Updated";
	}
	...
	function Row_Deleting(&$rs) {
		update_sql('update_uf_acc_cuentas', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rs[0], $rs[1], $rs[2], $rs[3]));
		// Enter your code here
		// To cancel, set return value to False
