...
//
// Table class for af_reportes_usuario
//
class caf_reportes_usuario extends cTable {
	var $c_Usuario;
	var $c_IReporte;
	var $f_Ult_Mod;
	...
	function __construct() {
		...
		$this->TableVar = 'af_reportes_usuario';
		$this->TableName = 'af_reportes_usuario';
		...
		// c_Usuario
		$this->c_Usuario = new cField('af_reportes_usuario', 'af_reportes_usuario', 'x_c_Usuario', 'c_Usuario', '`c_Usuario`', '`c_Usuario`', 200, -1, FALSE, '`EV__c_Usuario`', TRUE, TRUE, TRUE, 'FORMATTED TEXT');
		$this->fields['c_Usuario'] = &$this->c_Usuario;

		// c_IReporte
		$this->c_IReporte = new cField('af_reportes_usuario', 'af_reportes_usuario', 'x_c_IReporte', 'c_IReporte', '`c_IReporte`', '`c_IReporte`', 3, -1, FALSE, '`EV__c_IReporte`', TRUE, TRUE, TRUE, 'FORMATTED TEXT');
		...
		// c_Usuario_Ult_Mod
		$this->c_Usuario_Ult_Mod = new cField('af_reportes_usuario', 'af_reportes_usuario', 'x_c_Usuario_Ult_Mod', 'c_Usuario_Ult_Mod', '`c_Usuario_Ult_Mod`', '`c_Usuario_Ult_Mod`', 200, -1, FALSE, '`c_Usuario_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`af_reportes_usuario`";
	...
	function SqlKeyFilter() {
		return "`c_Usuario` = '@c_Usuario@' AND `c_IReporte` = @c_IReporte@";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "af_reportes_usuariolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("af_reportes_usuarioview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("af_reportes_usuarioview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "af_reportes_usuarioadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("af_reportes_usuarioedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("af_reportes_usuarioadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("af_reportes_usuariodelete.php", $this->UrlParm());
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKey[] = @$_GET["c_IReporte"]; // c_IReporte
			$arKeys[] = $arKey;
		...
		foreach ($arKeys as $key) {
			...
			if (!is_numeric($key[1])) // c_IReporte
				continue;
			$ar[] = $key;
		}
		return $ar;
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->c_IReporte->CurrentValue = $key[1];
