...
$af_umb_clientes_view = NULL; // Initialize page object first

class caf_umb_clientes_view extends caf_umb_clientes {
	...
	// Page object name
	var $PageObjName = 'af_umb_clientes_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["c_IDestino"] <> "") {
				...
				$sReturnUrl = "af_umb_clienteslist.php"; // Return to list
			}
			if (@$_GET["c_IReseller"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "af_umb_clienteslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "af_umb_clienteslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($af_umb_clientes_view)) $af_umb_clientes_view = new caf_umb_clientes_view();

// Page init
$af_umb_clientes_view->Page_Init();

// Page main
$af_umb_clientes_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_umb_clientes_view->Page_Render();
?>
...
// Page object
var af_umb_clientes_view = new ew_Page("af_umb_clientes_view");
af_umb_clientes_view.PageID = "view"; // Page ID
var EW_PAGE_ID = af_umb_clientes_view.PageID; // For backward compatibility

// Form object
var faf_umb_clientesview = new ew_Form("faf_umb_clientesview");

// Form_CustomValidate event
faf_umb_clientesview.Form_CustomValidate = 
...
faf_umb_clientesview.ValidateRequired = true;
<?php } else { ?>
faf_umb_clientesview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faf_umb_clientesview.Lists["x_c_IDestino"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_umb_clientesview.Lists["x_c_IReseller"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_umb_clientesview.Lists["x_c_ICliente"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $af_umb_clientes_view->ExportOptions->Render("body") ?>
<?php if (!$af_umb_clientes_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($af_umb_clientes_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $af_umb_clientes_view->ShowPageHeader(); ?>
<?php
$af_umb_clientes_view->ShowMessage();
?>
<form name="faf_umb_clientesview" id="faf_umb_clientesview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="af_umb_clientes">
<table class="ewGrid"><tr><td>
<table id="tbl_af_umb_clientesview" class="table table-bordered table-striped">
<?php if ($af_umb_clientes->c_IDestino->Visible) { // c_IDestino ?>
	<tr id="r_c_IDestino">
		<td><span id="elh_af_umb_clientes_c_IDestino"><?php echo $af_umb_clientes->c_IDestino->FldCaption() ?></span></td>
...
<?php echo $af_umb_clientes->c_IDestino->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_umb_clientes->c_IReseller->Visible) { // c_IReseller ?>
	<tr id="r_c_IReseller">
		<td><span id="elh_af_umb_clientes_c_IReseller"><?php echo $af_umb_clientes->c_IReseller->FldCaption() ?></span></td>
...
<?php echo $af_umb_clientes->c_IReseller->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_umb_clientes->c_ICliente->Visible) { // c_ICliente ?>
	<tr id="r_c_ICliente">
		<td><span id="elh_af_umb_clientes_c_ICliente"><?php echo $af_umb_clientes->c_ICliente->FldCaption() ?></span></td>
...
<?php echo $af_umb_clientes->c_ICliente->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_umb_clientes->q_MinAl_Cli->Visible) { // q_MinAl_Cli ?>
	<tr id="r_q_MinAl_Cli">
		<td><span id="elh_af_umb_clientes_q_MinAl_Cli"><?php echo $af_umb_clientes->q_MinAl_Cli->FldCaption() ?></span></td>
...
<?php echo $af_umb_clientes->q_MinAl_Cli->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_umb_clientes->q_MinCu_Cli->Visible) { // q_MinCu_Cli ?>
	<tr id="r_q_MinCu_Cli">
		<td><span id="elh_af_umb_clientes_q_MinCu_Cli"><?php echo $af_umb_clientes->q_MinCu_Cli->FldCaption() ?></span></td>
...
<?php echo $af_umb_clientes->q_MinCu_Cli->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_umb_clientes->f_Ult_Mod->Visible) { // f_Ult_Mod ?>
	<tr id="r_f_Ult_Mod">
		<td><span id="elh_af_umb_clientes_f_Ult_Mod"><?php echo $af_umb_clientes->f_Ult_Mod->FldCaption() ?></span></td>
		<td<?php echo $af_umb_clientes->f_Ult_Mod->CellAttributes() ?>>
<span id="el_af_umb_clientes_f_Ult_Mod" class="control-group">
<span<?php echo $af_umb_clientes->f_Ult_Mod->ViewAttributes() ?>>

<!-- Mostrar Fecha! -->
<?php $f = select_sql('select_fecha_umb', array('af_umb_clientes', $af_umb_clientes->c_IDestino->CurrentValue))?>
<?php /*echo $af_umb_clientes->f_Ult_Mod->ViewValue */ echo $f[1]['f_Ult_Mod'] ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_umb_clientes->c_Usuario_Ult_Mod->Visible) { // c_Usuario_Ult_Mod ?>
	<tr id="r_c_Usuario_Ult_Mod">
		<td><span id="elh_af_umb_clientes_c_Usuario_Ult_Mod"><?php echo $af_umb_clientes->c_Usuario_Ult_Mod->FldCaption() ?></span></td>
		<td<?php echo $af_umb_clientes->c_Usuario_Ult_Mod->CellAttributes() ?>>
<span id="el_af_umb_clientes_c_Usuario_Ult_Mod" class="control-group">
<span<?php echo $af_umb_clientes->c_Usuario_Ult_Mod->ViewAttributes() ?>>
<?php echo $af_umb_clientes->c_Usuario_Ult_Mod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
faf_umb_clientesview.Init();
</script>
<?php
$af_umb_clientes_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$af_umb_clientes_view->Page_Terminate();
?>
