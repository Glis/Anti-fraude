...
$af_acc_plataforma = NULL;

//
// Table class for af_acc_plataforma
//
class caf_acc_plataforma extends cTable {
	var $cl_Accion;
	var $t_Accion;
	var $x_DirCorreo;
	var $x_Titulo;
	...
	function __construct() {
		...
		// cl_Accion
		$this->cl_Accion = new cField('af_acc_plataforma', 'af_acc_plataforma', 'x_cl_Accion', 'cl_Accion', '`cl_Accion`', '`cl_Accion`', 3, -1, FALSE, '`cl_Accion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cl_Accion'] = &$this->cl_Accion;

		// t_Accion
		$this->t_Accion = new cField('af_acc_plataforma', 'af_acc_plataforma', 'x_t_Accion', 't_Accion', '`t_Accion`', '`t_Accion`', 3, -1, FALSE, '`t_Accion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['t_Accion'] = &$this->t_Accion;

		// x_DirCorreo
		$this->x_DirCorreo = new cField('af_acc_plataforma', 'af_acc_plataforma', 'x_x_DirCorreo', 'x_DirCorreo', '`x_DirCorreo`', '`x_DirCorreo`', 200, -1, FALSE, '`x_DirCorreo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['x_DirCorreo'] = &$this->x_DirCorreo;

		// x_Titulo
		$this->x_Titulo = new cField('af_acc_plataforma', 'af_acc_plataforma', 'x_x_Titulo', 'x_Titulo', '`x_Titulo`', '`x_Titulo`', 200, -1, FALSE, '`x_Titulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['x_Titulo'] = &$this->x_Titulo;

		// x_Mensaje
		$this->x_Mensaje = new cField('af_acc_plataforma', 'af_acc_plataforma', 'x_x_Mensaje', 'x_Mensaje', '`x_Mensaje`', '`x_Mensaje`', 201, -1, FALSE, '`x_Mensaje`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['x_Mensaje'] = &$this->x_Mensaje;

		// f_Ult_Mod
		$this->f_Ult_Mod = new cField('af_acc_plataforma', 'af_acc_plataforma', 'x_f_Ult_Mod', 'f_Ult_Mod', '`f_Ult_Mod`', 'DATE_FORMAT(`f_Ult_Mod`, \'%d/%m/%Y\')', 135, 9, FALSE, '`f_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->f_Ult_Mod->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['f_Ult_Mod'] = &$this->f_Ult_Mod;

		// c_Usuario_Ult_Mod
		$this->c_Usuario_Ult_Mod = new cField('af_acc_plataforma', 'af_acc_plataforma', 'x_c_Usuario_Ult_Mod', 'c_Usuario_Ult_Mod', '`c_Usuario_Ult_Mod`', '`c_Usuario_Ult_Mod`', 200, -1, FALSE, '`c_Usuario_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`af_acc_plataforma`";
	...
	function SqlKeyFilter() {
		return "`cl_Accion` = @cl_Accion@ AND `t_Accion` = @t_Accion@";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "af_acc_plataformalist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("af_acc_plataformaview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("af_acc_plataformaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "af_acc_plataformaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("af_acc_plataformaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("af_acc_plataformaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("af_acc_plataformadelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function Row_Deleting(&$rs) {
		update_sql('update_uf_acc_plataforma', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rs[0], $rs[1]));
		// Enter your code here
		// To cancel, set return value to False
