...
$af_acc_resellers_edit = NULL; // Initialize page object first

class caf_acc_resellers_edit extends caf_acc_resellers {
	...
	// Page object name
	var $PageObjName = 'af_acc_resellers_edit';
	...
	function Page_Main() {
		...
		if ($this->c_IReseller->CurrentValue == "")
			$this->Page_Terminate("af_acc_resellerslist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($af_acc_resellers_edit)) $af_acc_resellers_edit = new caf_acc_resellers_edit();

// Page init
$af_acc_resellers_edit->Page_Init();

// Page main
$af_acc_resellers_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_acc_resellers_edit->Page_Render();
?>
...
// Page object
var af_acc_resellers_edit = new ew_Page("af_acc_resellers_edit");
af_acc_resellers_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = af_acc_resellers_edit.PageID; // For backward compatibility

// Form object
var faf_acc_resellersedit = new ew_Form("faf_acc_resellersedit");

// Validate form
faf_acc_resellersedit.Validate = function() {
...
faf_acc_resellersedit.Form_CustomValidate = 
...
faf_acc_resellersedit.ValidateRequired = true;
<?php } else { ?>
faf_acc_resellersedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faf_acc_resellersedit.Lists["x_c_IReseller"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_resellersedit.Lists["x_cl_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_resellersedit.Lists["x_t_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $af_acc_resellers_edit->ShowPageHeader(); ?>
<?php
$af_acc_resellers_edit->ShowMessage();
?>
<form name="faf_acc_resellersedit" id="faf_acc_resellersedit" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="af_acc_resellers">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="k_hash" id="k_hash" value="<?php echo $af_acc_resellers_edit->HashValue ?>">
<div id="page_title"> - Editar</div>
<table class="ewGrid"><tr><td>
<table id="tbl_af_acc_resellersedit" class="table table-bordered table-striped">
...
<?php echo $af_acc_resellers->c_IReseller->EditValue ?></span>
</span>
<input type="hidden" data-field="x_c_IReseller" name="x_c_IReseller" id="x_c_IReseller" value="<?php echo ew_HtmlEncode($af_acc_resellers->c_IReseller->CurrentValue) ?>">
...
<?php echo $af_acc_resellers->cl_Accion->EditValue ?></span>
</span>
<input type="hidden" data-field="x_cl_Accion" name="x_cl_Accion" id="x_cl_Accion" value="<?php echo ew_HtmlEncode($af_acc_resellers->cl_Accion->CurrentValue) ?>">
...
<?php echo $af_acc_resellers->t_Accion->EditValue ?></span>
</span>
<input type="hidden" data-field="x_t_Accion" name="x_t_Accion" id="x_t_Accion" value="<?php echo ew_HtmlEncode($af_acc_resellers->t_Accion->CurrentValue) ?>">
...
<input class="form-control" type="text" data-field="x_x_DirCorreo" name="x_x_DirCorreo" id="x_x_DirCorreo" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($af_acc_resellers->x_DirCorreo->PlaceHolder) ?>" value="<?php echo $af_acc_resellers->x_DirCorreo->EditValue ?>"<?php echo $af_acc_resellers->x_DirCorreo->EditAttributes() ?>>
</span>
...
<?php if ($af_acc_resellers->x_Titulo->Visible) { // x_Titulo ?>
	<tr id="r_x_Titulo">
		<td>
			...
			<span id="elh_af_acc_resellers_x_Titulo"><?php echo $af_acc_resellers->x_Titulo->FldCaption() ?></span></td>
...
<?php if ($af_acc_resellers->x_Mensaje->Visible) { // x_Mensaje ?>
	<tr id="r_x_Mensaje">
		<td>
			...
			<span id="elh_af_acc_resellers_x_Mensaje"><?php echo $af_acc_resellers->x_Mensaje->FldCaption() ?></span></td>
...
<?php if ($af_acc_resellers->UpdateConflict == "U") { // Record already updated by other user ?>
...
<script type="text/javascript">
faf_acc_resellersedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$af_acc_resellers_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$af_acc_resellers_edit->Page_Terminate();
?>
