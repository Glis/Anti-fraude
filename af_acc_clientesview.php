...
$af_acc_clientes_view = NULL; // Initialize page object first

class caf_acc_clientes_view extends caf_acc_clientes {
	...
	// Page object name
	var $PageObjName = 'af_acc_clientes_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["cl_Accion"] <> "") {
				...
				$sReturnUrl = "af_acc_clienteslist.php"; // Return to list
			}
			if (@$_GET["t_Accion"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "af_acc_clienteslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "af_acc_clienteslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($af_acc_clientes_view)) $af_acc_clientes_view = new caf_acc_clientes_view();

// Page init
$af_acc_clientes_view->Page_Init();

// Page main
$af_acc_clientes_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_acc_clientes_view->Page_Render();
?>
...
// Page object
var af_acc_clientes_view = new ew_Page("af_acc_clientes_view");
af_acc_clientes_view.PageID = "view"; // Page ID
var EW_PAGE_ID = af_acc_clientes_view.PageID; // For backward compatibility

// Form object
var faf_acc_clientesview = new ew_Form("faf_acc_clientesview");

// Form_CustomValidate event
faf_acc_clientesview.Form_CustomValidate = 
...
faf_acc_clientesview.ValidateRequired = true;
<?php } else { ?>
faf_acc_clientesview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faf_acc_clientesview.Lists["x_cl_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_clientesview.Lists["x_t_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_clientesview.Lists["x_c_IReseller"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_clientesview.Lists["x_c_ICClass"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $af_acc_clientes_view->ExportOptions->Render("body") ?>
<?php if (!$af_acc_clientes_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($af_acc_clientes_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $af_acc_clientes_view->ShowPageHeader(); ?>
<?php
$af_acc_clientes_view->ShowMessage();
?>
<form name="faf_acc_clientesview" id="faf_acc_clientesview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="af_acc_clientes">
<table class="ewGrid"><tr><td>
<table id="tbl_af_acc_clientesview" class="table table-bordered table-striped">
<?php if ($af_acc_clientes->cl_Accion->Visible) { // cl_Accion ?>
	<tr id="r_cl_Accion">
		<td><span id="elh_af_acc_clientes_cl_Accion"><?php echo $af_acc_clientes->cl_Accion->FldCaption() ?></span></td>
...
<?php echo $af_acc_clientes->cl_Accion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_clientes->t_Accion->Visible) { // t_Accion ?>
	<tr id="r_t_Accion">
		<td><span id="elh_af_acc_clientes_t_Accion"><?php echo $af_acc_clientes->t_Accion->FldCaption() ?></span></td>
...
<?php echo $af_acc_clientes->t_Accion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_clientes->c_IReseller->Visible) { // c_IReseller ?>
	<tr id="r_c_IReseller">
		<td><span id="elh_af_acc_clientes_c_IReseller"><?php echo $af_acc_clientes->c_IReseller->FldCaption() ?></span></td>
...
<?php echo $af_acc_clientes->c_IReseller->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_clientes->c_ICClass->Visible) { // c_ICClass ?>
	<tr id="r_c_ICClass">
		<td><span id="elh_af_acc_clientes_c_ICClass"><?php echo $af_acc_clientes->c_ICClass->FldCaption() ?></span></td>
...
<?php echo $af_acc_clientes->c_ICClass->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $af_acc_clientes->x_DirCorreo->ViewAttributes() ?>>
<?php echo $af_acc_clientes->x_DirCorreo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $af_acc_clientes->x_Titulo->ViewAttributes() ?>>
<?php echo $af_acc_clientes->x_Titulo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $af_acc_clientes->x_Mensaje->ViewAttributes() ?>>
<?php echo $af_acc_clientes->x_Mensaje->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_clientes->f_Ult_Mod->Visible) { // f_Ult_Mod ?>
	<tr id="r_f_Ult_Mod">
		<td><span id="elh_af_acc_clientes_f_Ult_Mod"><?php echo $af_acc_clientes->f_Ult_Mod->FldCaption() ?></span></td>
		<td<?php echo $af_acc_clientes->f_Ult_Mod->CellAttributes() ?>>
<span id="el_af_acc_clientes_f_Ult_Mod" class="control-group">
<span<?php echo $af_acc_clientes->f_Ult_Mod->ViewAttributes() ?>>
<?php echo $af_acc_clientes->f_Ult_Mod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($af_acc_clientes->c_Usuario_Ult_Mod->Visible) { // c_Usuario_Ult_Mod ?>
	<tr id="r_c_Usuario_Ult_Mod">
		<td><span id="elh_af_acc_clientes_c_Usuario_Ult_Mod"><?php echo $af_acc_clientes->c_Usuario_Ult_Mod->FldCaption() ?></span></td>
		<td<?php echo $af_acc_clientes->c_Usuario_Ult_Mod->CellAttributes() ?>>
<span id="el_af_acc_clientes_c_Usuario_Ult_Mod" class="control-group">
<span<?php echo $af_acc_clientes->c_Usuario_Ult_Mod->ViewAttributes() ?>>
<?php echo $af_acc_clientes->c_Usuario_Ult_Mod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
faf_acc_clientesview.Init();
</script>
<?php
$af_acc_clientes_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$af_acc_clientes_view->Page_Terminate();
?>
