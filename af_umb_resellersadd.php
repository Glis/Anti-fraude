...
$af_umb_resellers_add = NULL; // Initialize page object first

class caf_umb_resellers_add extends caf_umb_resellers {
	...
	// Page object name
	var $PageObjName = 'af_umb_resellers_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "af_umb_resellersview.php")
...
// Create page object
if (!isset($af_umb_resellers_add)) $af_umb_resellers_add = new caf_umb_resellers_add();

// Page init
$af_umb_resellers_add->Page_Init();

// Page main
$af_umb_resellers_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_umb_resellers_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var af_umb_resellers_add = new ew_Page("af_umb_resellers_add");
af_umb_resellers_add.PageID = "add"; // Page ID
var EW_PAGE_ID = af_umb_resellers_add.PageID; // For backward compatibility

// Form object
var faf_umb_resellersadd = new ew_Form("faf_umb_resellersadd");

// Validate form
faf_umb_resellersadd.Validate = function() {
...
faf_umb_resellersadd.Form_CustomValidate = 
...
faf_umb_resellersadd.ValidateRequired = true;
<?php } else { ?>
faf_umb_resellersadd.ValidateRequired = false; 
<?php } ?>
...
<?php $af_umb_resellers_add->ShowPageHeader(); ?>
<?php
$af_umb_resellers_add->ShowMessage();
?>
<form name="faf_umb_resellersadd" id="faf_umb_resellersadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="af_umb_resellers">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_af_umb_resellersadd" class="table table-bordered table-striped">
...
<input type="text" data-field="x_q_MinAl_Res" name="x_q_MinAl_Res" id="x_q_MinAl_Res" size="30" placeholder="<?php echo ew_HtmlEncode($af_umb_resellers->q_MinAl_Res->PlaceHolder) ?>" value="<?php echo $af_umb_resellers->q_MinAl_Res->EditValue ?>"<?php echo $af_umb_resellers->q_MinAl_Res->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_q_MinCu_Res" name="x_q_MinCu_Res" id="x_q_MinCu_Res" size="30" placeholder="<?php echo ew_HtmlEncode($af_umb_resellers->q_MinCu_Res->PlaceHolder) ?>" value="<?php echo $af_umb_resellers->q_MinCu_Res->EditValue ?>"<?php echo $af_umb_resellers->q_MinCu_Res->EditAttributes() ?>>
</span>
...
<script type="text/javascript">
faf_umb_resellersadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$af_umb_resellers_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$af_umb_resellers_add->Page_Terminate();
?>
