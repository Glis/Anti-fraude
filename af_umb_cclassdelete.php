...
$af_umb_cclass_delete = NULL; // Initialize page object first

class caf_umb_cclass_delete extends caf_umb_cclass {
	...
	// Page object name
	var $PageObjName = 'af_umb_cclass_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("af_umb_cclasslist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in af_umb_cclass class, af_umb_cclassinfo.php
...
// Create page object
if (!isset($af_umb_cclass_delete)) $af_umb_cclass_delete = new caf_umb_cclass_delete();

// Page init
$af_umb_cclass_delete->Page_Init();

// Page main
$af_umb_cclass_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_umb_cclass_delete->Page_Render();
?>
...
// Page object
var af_umb_cclass_delete = new ew_Page("af_umb_cclass_delete");
af_umb_cclass_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = af_umb_cclass_delete.PageID; // For backward compatibility

// Form object
var faf_umb_cclassdelete = new ew_Form("faf_umb_cclassdelete");

// Form_CustomValidate event
faf_umb_cclassdelete.Form_CustomValidate = 
...
faf_umb_cclassdelete.ValidateRequired = true;
<?php } else { ?>
faf_umb_cclassdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faf_umb_cclassdelete.Lists["x_c_IDestino"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_umb_cclassdelete.Lists["x_c_IReseller"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_umb_cclassdelete.Lists["x_c_ICClass"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
if ($af_umb_cclass_delete->Recordset = $af_umb_cclass_delete->LoadRecordset())
	$af_umb_cclass_deleteTotalRecs = $af_umb_cclass_delete->Recordset->RecordCount(); // Get record count
if ($af_umb_cclass_deleteTotalRecs <= 0) { // No record found, exit
	if ($af_umb_cclass_delete->Recordset)
		$af_umb_cclass_delete->Recordset->Close();
	$af_umb_cclass_delete->Page_Terminate("af_umb_cclasslist.php"); // Return to list
}
?>
<?php $Breadcrumb->Render(); ?>
<?php $af_umb_cclass_delete->ShowPageHeader(); ?>
<?php
$af_umb_cclass_delete->ShowMessage();
?>
<form name="faf_umb_cclassdelete" id="faf_umb_cclassdelete" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="af_umb_cclass">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($af_umb_cclass_delete->RecKeys as $key) { ?>
...
<table id="tbl_af_umb_cclassdelete" class="ewTable ewTableSeparate">
<?php echo $af_umb_cclass->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($af_umb_cclass->c_IDestino->Visible) { // c_IDestino ?>
		<td><span id="elh_af_umb_cclass_c_IDestino" class="af_umb_cclass_c_IDestino"><?php echo $af_umb_cclass->c_IDestino->FldCaption() ?></span></td>
<?php } ?>
<?php if ($af_umb_cclass->c_IReseller->Visible) { // c_IReseller ?>
		<td><span id="elh_af_umb_cclass_c_IReseller" class="af_umb_cclass_c_IReseller"><?php echo $af_umb_cclass->c_IReseller->FldCaption() ?></span></td>
<?php } ?>
<?php if ($af_umb_cclass->c_ICClass->Visible) { // c_ICClass ?>
		<td><span id="elh_af_umb_cclass_c_ICClass" class="af_umb_cclass_c_ICClass"><?php echo $af_umb_cclass->c_ICClass->FldCaption() ?></span></td>
<?php } ?>
<?php if ($af_umb_cclass->q_MinAl_CClass->Visible) { // q_MinAl_CClass ?>
		<td><span id="elh_af_umb_cclass_q_MinAl_CClass" class="af_umb_cclass_q_MinAl_CClass"><?php echo $af_umb_cclass->q_MinAl_CClass->FldCaption() ?></span></td>
<?php } ?>
<?php if ($af_umb_cclass->q_MinCu_CClass->Visible) { // q_MinCu_CClass ?>
		<td><span id="elh_af_umb_cclass_q_MinCu_CClass" class="af_umb_cclass_q_MinCu_CClass"><?php echo $af_umb_cclass->q_MinCu_CClass->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$af_umb_cclass_delete->RecCnt = 0;
$i = 0;
while (!$af_umb_cclass_delete->Recordset->EOF) {
	$af_umb_cclass_delete->RecCnt++;
	$af_umb_cclass_delete->RowCnt++;

	// Set row properties
	$af_umb_cclass->ResetAttrs();
	$af_umb_cclass->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$af_umb_cclass_delete->LoadRowValues($af_umb_cclass_delete->Recordset);

	// Render row
	$af_umb_cclass_delete->RenderRow();
?>
	<tr<?php echo $af_umb_cclass->RowAttributes() ?>>
<?php if ($af_umb_cclass->c_IDestino->Visible) { // c_IDestino ?>
		<td<?php echo $af_umb_cclass->c_IDestino->CellAttributes() ?>>
<span id="el<?php echo $af_umb_cclass_delete->RowCnt ?>_af_umb_cclass_c_IDestino" class="control-group af_umb_cclass_c_IDestino">
...
<span id="el<?php echo $af_umb_cclass_delete->RowCnt ?>_af_umb_cclass_c_IReseller" class="control-group af_umb_cclass_c_IReseller">
...
<span id="el<?php echo $af_umb_cclass_delete->RowCnt ?>_af_umb_cclass_c_ICClass" class="control-group af_umb_cclass_c_ICClass">
...
<span id="el<?php echo $af_umb_cclass_delete->RowCnt ?>_af_umb_cclass_q_MinAl_CClass" class="control-group af_umb_cclass_q_MinAl_CClass">
...
<span id="el<?php echo $af_umb_cclass_delete->RowCnt ?>_af_umb_cclass_q_MinCu_CClass" class="control-group af_umb_cclass_q_MinCu_CClass">
...
<?php
	$af_umb_cclass_delete->Recordset->MoveNext();
}
$af_umb_cclass_delete->Recordset->Close();
?>
</tbody>
...
<script type="text/javascript">
faf_umb_cclassdelete.Init();
</script>
<?php
$af_umb_cclass_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$af_umb_cclass_delete->Page_Terminate();
?>
