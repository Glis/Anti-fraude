...
//
// Table class for af_umb_cuentas
//
class caf_umb_cuentas extends cTable {
	var $c_IDestino;
	var $c_IReseller;
	var $c_ICliente;
	var $c_ICuenta;
	...
	function __construct() {
		...
		$this->TableVar = 'af_umb_cuentas';
		$this->TableName = 'af_umb_cuentas';
		...
		// c_IDestino
		$this->c_IDestino = new cField('af_umb_cuentas', 'af_umb_cuentas', 'x_c_IDestino', 'c_IDestino', '`c_IDestino`', '`c_IDestino`', 200, -1, FALSE, '`c_IDestino`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_IDestino'] = &$this->c_IDestino;

		// c_IReseller
		$this->c_IReseller = new cField('af_umb_cuentas', 'af_umb_cuentas', 'x_c_IReseller', 'c_IReseller', '`c_IReseller`', '`c_IReseller`', 200, -1, FALSE, '`c_IReseller`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_IReseller'] = &$this->c_IReseller;

		// c_ICliente
		$this->c_ICliente = new cField('af_umb_cuentas', 'af_umb_cuentas', 'x_c_ICliente', 'c_ICliente', '`c_ICliente`', '`c_ICliente`', 200, -1, FALSE, '`c_ICliente`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_ICliente'] = &$this->c_ICliente;

		// c_ICuenta
		$this->c_ICuenta = new cField('af_umb_cuentas', 'af_umb_cuentas', 'x_c_ICuenta', 'c_ICuenta', '`c_ICuenta`', '`c_ICuenta`', 200, -1, FALSE, '`c_ICuenta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['c_ICuenta'] = &$this->c_ICuenta;

		// q_MinAl_Cta
		$this->q_MinAl_Cta = new cField('af_umb_cuentas', 'af_umb_cuentas', 'x_q_MinAl_Cta', 'q_MinAl_Cta', '`q_MinAl_Cta`', '`q_MinAl_Cta`', 3, -1, FALSE, '`q_MinAl_Cta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->q_MinAl_Cta->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['q_MinAl_Cta'] = &$this->q_MinAl_Cta;

		// q_MinCu_Cta
		$this->q_MinCu_Cta = new cField('af_umb_cuentas', 'af_umb_cuentas', 'x_q_MinCu_Cta', 'q_MinCu_Cta', '`q_MinCu_Cta`', '`q_MinCu_Cta`', 3, -1, FALSE, '`q_MinCu_Cta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->q_MinCu_Cta->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['q_MinCu_Cta'] = &$this->q_MinCu_Cta;

		// f_Ult_Mod
		$this->f_Ult_Mod = new cField('af_umb_cuentas', 'af_umb_cuentas', 'x_f_Ult_Mod', 'f_Ult_Mod', '`f_Ult_Mod`', 'DATE_FORMAT(`f_Ult_Mod`, \'%d/%m/%Y\')', 135, 9, FALSE, '`f_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->f_Ult_Mod->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['f_Ult_Mod'] = &$this->f_Ult_Mod;

		// c_Usuario_Ult_Mod
		$this->c_Usuario_Ult_Mod = new cField('af_umb_cuentas', 'af_umb_cuentas', 'x_c_Usuario_Ult_Mod', 'c_Usuario_Ult_Mod', '`c_Usuario_Ult_Mod`', '`c_Usuario_Ult_Mod`', 200, -1, FALSE, '`c_Usuario_Ult_Mod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlWhere() { // Where
		$where="";
		if(($_SESSION['filtros_umb']['destino'] == "") && ($_SESSION['filtros_umb']['reseller'] == "") && ($_SESSION['filtros_umb']['cname'] == "")){
			...
			if(($_SESSION['filtros_umb']['reseller'] != "" || $_SESSION['filtros_umb']['destino'] != "") && $_SESSION['filtros_umb']['cname'] != ""){
				//$where .= " AND " . $this->SqlFrom().".`c_ICClass`=" .$_SESSION['filtros_umb']['cclass'];

					//$where = $this->SqlFrom().".`c_ICClass`=" .$_SESSION['filtros_umb']['cclass'];
					$cant = count($_SESSION['filtros_umb']['destino']);
					$k = 1;
					$where .= " AND". $this->SqlFrom().".`c_ICliente` IN (";
					while($k <= $cant - 1){
						$where .= $_SESSION['filtros_umb']['cname'][$k]['i_customer']. ", ";
						$k++;
					}
				...
				if($_SESSION['filtros_umb']['cname'] != ""){
					...
					$cant = count($_SESSION['filtros_umb']['destino']);
					$k = 1;
					$where = $this->SqlFrom().".`c_ICliente` IN (";
					while($k <= $cant - 1){
						$where .= $_SESSION['filtros_umb']['cname'][$k]['i_customer']. ", ";
						$k++;
					}
	...
	// Update Table
	var $UpdateTable = "`af_umb_cuentas`";
	...
	function SqlKeyFilter() {
		return "`c_IDestino` = '@c_IDestino@' AND `c_IReseller` = '@c_IReseller@' AND `c_ICliente` = '@c_ICliente@' AND `c_ICuenta` = '@c_ICuenta@'";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("af_umb_cuentasview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("af_umb_cuentasview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "af_umb_cuentasadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("af_umb_cuentasedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("af_umb_cuentasadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("af_umb_cuentasdelete.php", $this->UrlParm());
	}
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->c_ICliente->CurrentValue = $key[2];
			$this->c_ICuenta->CurrentValue = $key[3];
   ...
   // Common render codes
	...
	function Row_Updated($rsold, &$rsnew) {
		update_sql('update_uf_umb_cuentas', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rsold[0], $rsold[1], $rsold[2], $rsold[3]));
	...
	function Row_Deleting(&$rs) {
		update_sql('update_uf_umb_clientes', array(gmdate("Y-m-d H:i:s"), $_SESSION['USUARIO'], $rs[0], $rs[1], $rs[2], $rs[3]));
