...
<div id="tableContainer" class="col-sm-12">
  <!-- <form role="form" action="" method="post"> -->
    <div class="row">
      ...
      <div class="col-sm-5">
        <div class="form-group">
          <label for="endDateFil">Destino</label>
      ...
      <div class="col-sm-5">
        <div class="form-group">
          <label for="endDateFil">Reseller</label>
      ...
      <div class="col-sm-5">
        <div class="form-group">
          <label for="endDateFil">Customer Class</label>
...
$(document).on('click','#gen_rep',function(){
  $(location).attr('href','download.php?type="calidad_destinos"');
