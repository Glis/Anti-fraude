...
$af_resellers_usuario_add = NULL; // Initialize page object first

class caf_resellers_usuario_add extends caf_resellers_usuario {
	...
	// Page object name
	var $PageObjName = 'af_resellers_usuario_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("af_resellers_usuariolist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "af_resellers_usuarioview.php")
...
// Create page object
if (!isset($af_resellers_usuario_add)) $af_resellers_usuario_add = new caf_resellers_usuario_add();

// Page init
$af_resellers_usuario_add->Page_Init();

// Page main
$af_resellers_usuario_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_resellers_usuario_add->Page_Render();
?>
...
// Page object
var af_resellers_usuario_add = new ew_Page("af_resellers_usuario_add");
af_resellers_usuario_add.PageID = "add"; // Page ID
var EW_PAGE_ID = af_resellers_usuario_add.PageID; // For backward compatibility

// Form object
var faf_resellers_usuarioadd = new ew_Form("faf_resellers_usuarioadd");

// Validate form
faf_resellers_usuarioadd.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_HasValue(elm))
				return this.OnError(elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($af_resellers_usuario->c_Usuario->FldCaption()) ?>");
			elm = this.GetElements("x" + infix + "_c_IReseller");
			if (elm && !ew_HasValue(elm))
				return this.OnError(elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($af_resellers_usuario->c_IReseller->FldCaption()) ?>");
...
faf_resellers_usuarioadd.Form_CustomValidate = 
...
faf_resellers_usuarioadd.ValidateRequired = true;
<?php } else { ?>
faf_resellers_usuarioadd.ValidateRequired = false; 
<?php } ?>
...
<?php $af_resellers_usuario_add->ShowPageHeader(); ?>
<?php
$af_resellers_usuario_add->ShowMessage();
?>
...
<script type="text/javascript">
faf_resellers_usuarioadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$af_resellers_usuario_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$af_resellers_usuario_add->Page_Terminate();
?>
