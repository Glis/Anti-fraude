...
$af_acc_cclass_add = NULL; // Initialize page object first

class caf_acc_cclass_add extends caf_acc_cclass {
	...
	// Page object name
	var $PageObjName = 'af_acc_cclass_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "af_acc_cclassview.php")
...
// Create page object
if (!isset($af_acc_cclass_add)) $af_acc_cclass_add = new caf_acc_cclass_add();

// Page init
$af_acc_cclass_add->Page_Init();

// Page main
$af_acc_cclass_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$af_acc_cclass_add->Page_Render();
?>
...
af_acc_cclass_add.PageID = "add"; // Page ID
var EW_PAGE_ID = af_acc_cclass_add.PageID; // For backward compatibility

// Form object
var faf_acc_cclassadd = new ew_Form("faf_acc_cclassadd");

// Validate form
faf_acc_cclassadd.Validate = function() {
...
faf_acc_cclassadd.Form_CustomValidate = 
...
faf_acc_cclassadd.ValidateRequired = true;
<?php } else { ?>
faf_acc_cclassadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
faf_acc_cclassadd.Lists["x_cl_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_cclassadd.Lists["x_t_Accion"] = {"LinkField":"x_rv_Low_Value","Ajax":null,"AutoFill":false,"DisplayFields":["x_rv_Meaning","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_cclassadd.Lists["x_c_IReseller"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
faf_acc_cclassadd.Lists["x_c_ICClass"] = {"LinkField":"x_c_Usuario","Ajax":null,"AutoFill":false,"DisplayFields":["x_c_Usuario","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $af_acc_cclass_add->ShowPageHeader(); ?>
<?php
$af_acc_cclass_add->ShowMessage();
?>
...
if (is_array($af_acc_cclass->cl_Accion->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($af_acc_cclass->cl_Accion->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
faf_acc_cclassadd.Lists["x_cl_Accion"].Options = <?php echo (is_array($af_acc_cclass->cl_Accion->EditValue)) ? ew_ArrayToJson($af_acc_cclass->cl_Accion->EditValue, 1) : "[]" ?>;
</script>
</span>
...
if (is_array($af_acc_cclass->t_Accion->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($af_acc_cclass->t_Accion->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
faf_acc_cclassadd.Lists["x_t_Accion"].Options = <?php echo (is_array($af_acc_cclass->t_Accion->EditValue)) ? ew_ArrayToJson($af_acc_cclass->t_Accion->EditValue, 1) : "[]" ?>;
</script>
</span>
...
if (is_array($af_acc_cclass->c_IReseller->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($af_acc_cclass->c_IReseller->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
faf_acc_cclassadd.Lists["x_c_IReseller"].Options = <?php echo (is_array($af_acc_cclass->c_IReseller->EditValue)) ? ew_ArrayToJson($af_acc_cclass->c_IReseller->EditValue, 1) : "[]" ?>;
</script>
</span>
...
if (is_array($af_acc_cclass->c_ICClass->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($af_acc_cclass->c_ICClass->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
<script type="text/javascript">
faf_acc_cclassadd.Lists["x_c_ICClass"].Options = <?php echo (is_array($af_acc_cclass->c_ICClass->EditValue)) ? ew_ArrayToJson($af_acc_cclass->c_ICClass->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<input type="text" data-field="x_x_DirCorreo" name="x_x_DirCorreo" id="x_x_DirCorreo" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($af_acc_cclass->x_DirCorreo->PlaceHolder) ?>" value="<?php echo $af_acc_cclass->x_DirCorreo->EditValue ?>"<?php echo $af_acc_cclass->x_DirCorreo->EditAttributes() ?>>
</span>
...
<script type="text/javascript">
faf_acc_cclassadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$af_acc_cclass_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
